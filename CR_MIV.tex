...
%\begin{figure}
%  \centering
%  \includegraphics{manipulateur.png}
...
%\begin{figure}
%  \centering
%  \includegraphics{ajout_haptique.png}
...
%\begin{figure}
%  \centering
%  \includegraphics{retour_force.png}
...
%\begin{figure}
%  \centering
%  \includegraphics{fixation_code.png}
...
%\begin{figure}
%  \centering
%  \includegraphics{couleur_points_fixes.png}
...
%\begin{figure}
%  \centering
%  \includegraphics{modes.png}
%  \caption{Les deux modes possibles sont des entiers.}
%  \label{fig:}
%\end{figure}
%\begin{figure}
%  \centering
%  \includegraphics{press_m.png}
...
%\begin{figure}
%  \centering
%  \includegraphics{gestes_base.png}
%  \caption{Le pinch est reconnu par le Leap motion.}
%  \label{fig:}
%\end{figure}
%\begin{figure}
%  \centering
%  \includegraphics{geste_base2.png}
